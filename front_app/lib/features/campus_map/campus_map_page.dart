                    ...
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        ...
                        colors: [
                          ...
                          context.tokens.panelSubtle,
                          context.tokens.backdropMiddle,
                        ],
                      ),
                    ),
...
class _MissingCampusRasterNotice extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ColoredBox(
      color: context.tokens.backdropMiddle,
      child: Center(
        child: FrostedGlass(
          width: 440,
    ...
    return Transform.rotate(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: context.tokens.shadowSm.first.color,
              blurRadius: 10,
...
class _CampusMapStyles {
  ...
  static const List<_ColorOption> colorOptions = [
    ...
    _ColorOption(
      key: 'amber',
      label: '\u7425\u73c0\u9ec4',
      color: MapPalette.amber,
    ),
    _ColorOption(
      key: 'slate',
      label: '\u77f3\u677f\u7070',
      color: MapPalette.slate,
    ),
    _ColorOption(
      key: 'berry',
      label: '\u8393\u679c\u7ea2',
      color: MapPalette.berry,
    ),
    _ColorOption(
      key: 'teal',
      label: '\u6e56\u6c34\u84dd',
      color: MapPalette.teal,
    ),
    _ColorOption(
      key: 'blue',
      label: '\u6821\u56ed\u84dd',
      color: MapPalette.campusBlue,
    ),
  ];
  ...
  static Color colorForKey(String key) {
    ...
    return MapPalette.forest;
  }

  static Color categoryColor(PlaceCategory category) {
    return MapPalette.categoryColor(category);
  }
}
