...
/// 从事件中提取具体时间（零点视为未设置具体时间）。
TimeOfDay? _extractTime(EventItem? event) {
...
/// 把对话框选择的时间转成 controller 需要的 DateTime（仅用时分）。
          ...
          children: [
            ...
            Row(
              children: [
                Expanded(
                  child: Text(
                    '具体时间：${_time == null ? '未设置' : _formatTime(_time!)}',
                    style: Theme.of(context).textTheme.bodyMedium,
                  ),
                ),
                TextButton(
