...
/// 记录类型标识色：校历导入 / 周分析。数据语义色，主题无关（同 map_palette 原则）。
const Color _institutionAccent = Color(0xFF536D7A);
const Color _weeklyAccent = Color(0xFF16342D);
          ...
          child: Column(
            ...
            children: [
              Wrap(
                ...
                runSpacing: 12,
                children: [
                  StatusBadge(label: '会话内历史记录', color: context.tokens.accent),
                  StatusBadge(
